 ...
 *    <script src="js/langs/jquery-bootstrap-multiselect.pt.js"></script>
 * 
 * 2. Set the global language (affects all instances):
 *    $.fn.bootstrapMultiSelect.lang = 'pt';
 * 
 * 3. Or set language per instance:
 *    $('#mySelect').bootstrapMultiSelect({ lang: 'pt' });
 * 
...
(function ($) {
    ...
    // Register Portuguese language
    $.fn.bootstrapMultiSelect.langs['pt'] = {
    ...
    // To use Portuguese globally, add this line after loading this file:
    // $.fn.bootstrapMultiSelect.lang = 'pt';
    //
    // Or use data-lang="pt" on specific elements to use Portuguese for those instances only.
